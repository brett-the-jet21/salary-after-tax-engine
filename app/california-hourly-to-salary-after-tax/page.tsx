...
export const metadata = {
  title: "California Hourly to Salary After Tax (2026) — Calculator",
  description: "Convert hourly wages to after-tax pay in California for 2026. Includes federal tax, FICA, CA state tax, and CA SDI."
};
  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto", padding: "28px 16px", lineHeight: 1.55 }}>
      <header style={{ marginBottom: 18 }}>
        <h1 style={{ fontSize: 34, margin: "0 0 10px 0" }}>California hourly to salary after tax</h1>
        <p style={{ margin: 0, color: "#374151" }}>Enter an hourly wage and see an estimated after-tax paycheck in California. Switch pay periods to match how you’re paid.</p>
      </header>
      ...
      <section style={{ marginBottom: 14 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>Hourly → annual conversion (and back)</li><li>After-tax estimates including CA SDI</li><li>Great for offer comparisons</li>
        </ul>
      </section>
