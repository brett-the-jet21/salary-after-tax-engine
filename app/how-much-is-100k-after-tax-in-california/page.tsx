...
export const metadata = {
  title: "How Much Is $100k After Tax in California? (2026)",
  description: "Estimate take-home pay for $100,000 salary in California for 2026. Includes federal tax, FICA, CA state tax, and CA SDI."
};
  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto", padding: "28px 16px", lineHeight: 1.55 }}>
      <header style={{ marginBottom: 18 }}>
        <h1 style={{ fontSize: 34, margin: "0 0 10px 0" }}>How much is $100k after tax in California?</h1>
        <p style={{ margin: 0, color: "#374151" }}>Use the calculator to get a fast estimate for $100,000 salary in California and view take-home pay by annual/monthly/biweekly/weekly.</p>
      </header>
      ...
      <section style={{ marginBottom: 14 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>Rough take-home estimate for $100k in CA</li><li>Biggest drivers: filing status + withholding</li><li>See the exact breakdown in the calculator</li>
        </ul>
      </section>
