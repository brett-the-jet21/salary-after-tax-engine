...
export const metadata = {
  ...
  description: "Free California paycheck calculator for 2026. Estimate take-home pay with federal tax, FICA, CA state tax, and CA SDI."
};
  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto", padding: "28px 16px", lineHeight: 1.55 }}>
      <header style={{ marginBottom: 18 }}>
        <h1 style={{ fontSize: 34, margin: "0 0 10px 0" }}>California Paycheck Calculator</h1>
        <p style={{ margin: 0, color: "#374151" }}>Estimate your California take-home pay in seconds. Use the main calculator to see annual, monthly, biweekly, or weekly results with a clear tax breakdown.</p>
      </header>
      ...
      <section style={{ marginBottom: 14 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>Take-home pay estimates by pay period</li><li>Includes federal + FICA + CA state + CA SDI</li><li>Quick answers + FAQ for common questions</li>
        </ul>
      </section>
