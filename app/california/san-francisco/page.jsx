export const metadata = {
  title: "Salary After Tax in San Francisco, CA (2026) — Take-Home Pay",
  description: "Estimate take-home pay in San Francisco, California after federal tax, FICA, CA income tax, and CA SDI. Fast and accurate.",
  ...
  return (
    <main style={{ maxWidth: 980, margin: "0 auto", padding: "28px 16px" }}>
      <h1 style={{ margin: 0, fontSize: 28 }}>
        Salary After Tax in San Francisco, California
      </h1>

      <p style={{ marginTop: 12, lineHeight: 1.7 }}>
        Use our California Salary After Tax Calculator to estimate your take-home pay in San Francisco.
      ...
      <div style={{
        ...
        <h2 style={{ margin: 0 }}>Get your exact San Francisco take-home pay</h2>
      ...
      <section style={{ marginTop: 18 }}>
        <h2>Why take-home pay matters in San Francisco</h2>
        <ul>
