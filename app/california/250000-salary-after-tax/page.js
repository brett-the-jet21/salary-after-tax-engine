...
export default function Page() {
  ...
  const [annualSalary, setAnnualSalary] = useState("250000"); // ✅ prefill
  ...
  // ✅ safer than inline <script> in Next.js pages
  useEffect(() => {
    try {
  ...
  return (
    <div style={pageWrapStyle}>
      ...
      <div style={containerStyle}>
        <div style={cardStyle}>
          <h1>$250,000 Salary After Tax in California (2026)</h1>
          <p>
            Estimate your <strong>California take-home pay</strong> for a $250,000 salary
            using federal tax, FICA, California state tax, and CA SDI.
          </p>
          ...
          {/* ✅ MONEY SLOT #1 (best placement: after results) */}
          ...
          <section style={seoWrapStyle} aria-label="California salary after tax calculator details">
            <h2 style={seoH2Style}>$250,000 Salary After Tax in California</h2>
            <p style={seoPStyle}>
              This page estimates your <strong>California take-home pay</strong> (net pay) for a
              <strong> $250,000 salary</strong> after <strong>federal income tax</strong>, <strong>FICA</strong>,
              <strong> California state income tax</strong>, and <strong>CA SDI</strong>.
            </p>

            <h2 style={seoH2Style}>How Take-Home Pay Is Calculated</h2>
            <ul style={seoUlStyle}>
            ...
            <h2 style={seoH2Style}>Pay Frequency</h2>
            <p style={seoPStyle}>
              Pay frequency changes paycheck size, but generally does <strong>not</strong> change total annual taxes.
              Use the dropdown to view take-home pay as {`"${label}"`}.
            </p>
            ...
            <div style={faqItemStyle}>
              ...
              <div style={seoPStyle}>
                It’s an estimate. Your actual paycheck can vary based on benefits, 401(k), HSA,
                bonuses, and employer withholding settings.
              </div>
            </div>
