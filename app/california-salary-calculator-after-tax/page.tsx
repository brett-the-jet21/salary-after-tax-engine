...
export const metadata = {
  title: "California Salary Calculator After Tax (2026) — Take-Home Pay",
  description: "California salary after-tax calculator for 2026. See take-home pay after federal tax, FICA, California state tax, and CA SDI."
};
  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto", padding: "28px 16px", lineHeight: 1.55 }}>
      <header style={{ marginBottom: 18 }}>
        <h1 style={{ fontSize: 34, margin: "0 0 10px 0" }}>California Salary Calculator After Tax</h1>
        <p style={{ margin: 0, color: "#374151" }}>If you’re searching “salary after tax in California,” this page routes you to the calculator that shows take-home pay plus a simple breakdown of what’s withheld.</p>
      </header>
      ...
      <section style={{ marginBottom: 14 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>After-tax salary estimates (CA)</li><li>Why paychecks differ from salary</li><li>How withholding + filing status impact take-home</li>
        </ul>
      </section>
