...
export const metadata = {
  title: "$35/Hour After Tax in California (2026 Paycheck Calculator)",
  description:
    "See your take-home pay after taxes if you make $35 an hour in California. Weekly, biweekly, monthly breakdown."
};

export default function Page() {
  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      <h1>$35 an Hour After Tax in California</h1>

      <p>
        Earning <strong>$35 per hour in California</strong> means your
        take-home pay will vary based on hours worked and tax withholdings.
      </p>

      <Calculator presetHourly="35" />
      ...
      <RelatedHourly rate={35} />
<h2>Annual salary equivalent</h2>
      <p>
        At 40 hours per week, $35/hour equals approximately{" "}
        <strong>$72800</strong> per year before taxes.
      </p>
