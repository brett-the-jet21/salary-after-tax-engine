...
export const metadata = {
  ...
  description:
    "See your take-home pay after taxes if you make $25 an hour in California. Weekly, biweekly, monthly breakdown."
};
...
export default function Page() {
  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      ...
      <p>
        Earning <strong>$25 per hour in California</strong> means your
      ...
      <RelatedHourly rate={25} />
<h2>Annual salary equivalent</h2>
      <p>
        At 40 hours per week, $25/hour equals approximately{" "}
        <strong>$52000</strong> per year before taxes.
      </p>
