...
export const metadata = {
  ...
  description:
    "Calculate your take-home pay in California if you earn $370000 per year. Includes federal tax, CA state tax, FICA, and SDI. Updated for 2026."
};
...
export default function Page() {
  ...
  const annualIncome = 370000;
  const out = calculateCaliforniaTakeHome({ salary: annualIncome / div, filingStatus: "single" });

  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      <h1>$370000 Salary After Tax in California</h1>

      <p>
        If your annual salary is <strong>$370000</strong> in California, your
