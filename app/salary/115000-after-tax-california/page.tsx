...
export const metadata = {
  title: "$115000 Salary After Tax in California (2026 Take-Home Pay)",
  description:
    "Calculate your take-home pay in California if you earn $115000 per year. Includes federal tax, CA state tax, FICA, and SDI. Updated for 2026."
};
...
export default function Page() {
  ...
  const annualIncome = 115000;
  const out = calculateCaliforniaTakeHome({ annualIncome, filingStatus: "single" });

  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      <h1>$115000 Salary After Tax in California</h1>

      <p>
        If your annual salary is <strong>$115000</strong> in California, your
        actual take-home pay depends on federal income tax, California state tax,
        Social Security, Medicare, and SDI.
      </p>

      <Calculator presetSalary="115000" />

      

      <RelatedSalaries salary={115000} />
