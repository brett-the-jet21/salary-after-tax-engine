...
export const metadata = {
  ...
  description:
    "See your take-home pay after federal tax, California state tax, SDI, and FICA on a $40000 salary. Updated for 2026."
};
...
export default function Page() {
  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      ...
      <p>
        If you earn <strong>$40000 per year in California</strong>, your
      ...
      <h2>How taxes affect a $40000 salary in CA</h2>
      <p>
