...
export const metadata = {
  ...
  description:
    "Calculate your take-home pay in California if you earn $260000 per year. Includes federal tax, CA state tax, FICA, and SDI. Updated for 2026."
};
...
export default function Page() {
  ...
  const annualIncome = 260000;
  const out = calculateCaliforniaTakeHome({ annualIncome, filingStatus: "single" });

  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      <h1>$260000 Salary After Tax in California</h1>

      <p>
        If your annual salary is <strong>$260000</strong> in California, your
