...
export const metadata = {
  title: "$65000 Salary After Tax in California (2026 Take-Home Pay)",
  description:
    "Calculate your take-home pay in California if you earn $65000 per year. Includes federal tax, CA state tax, FICA, and SDI. Updated for 2026."
};
