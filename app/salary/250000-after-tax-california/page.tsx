...
export const metadata = {
  title: "$250000 Salary After Tax in California (2026 Take-Home Pay)",
  description:
    "Calculate your take-home pay in California if you earn $250000 per year. Includes federal tax, CA state tax, FICA, and SDI. Updated for 2026."
};
...
export default function Page() {
  ...
  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      <h1>$250000 Salary After Tax in California</h1>

      <p>
        If your annual salary is <strong>$250000</strong> in California, your
        actual take-home pay depends on federal income tax, California state tax,
        Social Security, Medicare, and SDI.
      </p>

      <Calculator presetSalary="250000" />

      

      <RelatedSalaries salary={250000} />
