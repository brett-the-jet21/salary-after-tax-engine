...
export const metadata = {
  ...
  description:
    "Calculate your take-home pay in California if you earn $90000 per year. Includes federal tax, CA state tax, FICA, and SDI. Updated for 2026."
};
...
export default function Page() {
  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: 24 }}>
      ...
      <p>
        If your annual salary is <strong>$90000</strong> in California, your
