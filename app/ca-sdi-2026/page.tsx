...
export const metadata = {
  title: "CA SDI (2026) — What It Is + How It Affects Paychecks",
  description: "Learn what California SDI is and how it impacts your paycheck in 2026. Use the calculator to see estimated SDI withholding."
};
  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto", padding: "28px 16px", lineHeight: 1.55 }}>
      <header style={{ marginBottom: 18 }}>
        <h1 style={{ fontSize: 34, margin: "0 0 10px 0" }}>CA SDI (2026): what it is and how it affects take-home pay</h1>
        <p style={{ margin: 0, color: "#374151" }}>California SDI is a payroll deduction that can reduce take-home pay. Use the calculator to see an estimate alongside your other withholdings.</p>
      </header>
      ...
      <section style={{ marginBottom: 14 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>Plain-English SDI explanation</li><li>Why SDI matters to take-home pay</li><li>See SDI estimate inside the calculator</li>
        </ul>
      </section>
