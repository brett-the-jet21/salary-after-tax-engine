...
export default function TexasPage() {
  ...
  // A simple per-period “breakdown” using annual components divided by periods
    ...
    <main className="min-h-screen bg-white text-slate-900">
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        <p className="mt-2 text-slate-600">
          Estimate your take-home pay in Texas after <b>federal taxes</b> and <b>FICA</b>.
          Texas has <b>no state income tax</b>.
        </p>
        ...
        {/* SEO text (keeps page from being “just a tool”) */}
