...
export const metadata = {
  title: "California Salary After Tax — FAQ (2026)",
  description: "FAQ for the California Salary After Tax Calculator (2026). How it works, what it includes, and how to interpret results."
};
  ...
  return (
    <main style={{ maxWidth: 860, margin: "0 auto", padding: "28px 16px", lineHeight: 1.55 }}>
      <header style={{ marginBottom: 18 }}>
        <h1 style={{ fontSize: 34, margin: "0 0 10px 0" }}>FAQ: California Salary After Tax Calculator</h1>
        <p style={{ margin: 0, color: "#374151" }}>Quick answers to the most common questions about the calculator and your take-home pay estimate.</p>
      </header>
      ...
      <section style={{ marginBottom: 14 }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>What taxes are included</li><li>How accurate the estimate is</li><li>How to interpret the breakdown</li>
        </ul>
      </section>
